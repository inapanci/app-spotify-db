...
INSERT INTO `filters` VALUES (1,'country',NULL,'US'),(2,'subscription',NULL,'Spotify Free'),(3,'country',NULL,'US'),(4,'country',NULL,'CA');
...
INSERT INTO `messages` VALUES (1,'test','1',2,'0','2021-03-04 00:00:00'),(2,'posttt','1',1,'0','2021-03-04 16:21:58'),(3,'messg 2 of ticket 2','1',2,'0','2021-03-08 22:44:15'),(4,'test','1',2,'0','2021-03-08 22:46:11'),(5,'jienvijo','1',2,'0','2021-03-08 22:50:29'),(6,'new post','1',2,'0','2021-04-25 01:53:56');
...
INSERT INTO `order_filters` VALUES (1,1),(7,1),(11,1),(12,1),(13,1),(7,2),(9,3);
...
INSERT INTO `orders` VALUES (1,'2021-03-03 00:00:00','1',4,1,25.00,2),(2,'2021-03-02 00:00:00','2',3,1,36.00,4),(3,'2021-03-03 23:04:03','2',3,1,15.00,2),(4,'2021-03-03 23:21:02','2',2,1,15.00,2),(5,'2021-03-08 23:16:04','2',1,1,15.00,2),(6,'2021-03-08 23:17:15','2',1,1,15.00,2),(7,'2021-04-22 22:06:22','1',NULL,1,25.00,2),(9,'2021-04-25 23:05:17','1',NULL,1,25.00,2),(11,'2021-04-25 23:17:16','1',NULL,1,25.00,5),(12,'2021-04-27 22:46:02','1',3,1,150.00,5),(13,'2021-04-27 23:07:18','1',3,1,150.00,2);
...
INSERT INTO `payment_methods` VALUES (1,'paypal','active','inactive',0,1,'updaeduser@paypalemail.com',NULL),(2,'coinbase','inactive','inactive',0,0,'niuvfhi3287854dnfj',NULL),(3,'manual ','inactive','active',0,1,NULL,NULL);
...
INSERT INTO `ticket_status` VALUES (1,'opened'),(2,'pending'),(3,'closed'),(4,'new replies');
...
INSERT INTO `transaction_status` VALUES (1,'confirmed'),(2,'pending'),(3,'rejected');
...
INSERT INTO `transactions` VALUES (1,'1',1,12.25,1,'2021-03-02 00:00:00','test for get all',NULL),(2,'1',1,35.25,1,'2021-03-05 22:55:32','test for post',NULL),(3,'1',NULL,35.25,1,'2021-04-22 23:36:40','test for post if it will work for users balance to change',NULL),(4,'1',NULL,35.25,1,'2021-04-22 23:39:12','test for post if it will work for users balance to change',NULL);
...
INSERT INTO `users` VALUES ('1','ina','UPDATEDina@test.com','user',NULL,NULL,170.50,1,'1','inaina'),('2','test','test@test.com','admin',NULL,NULL,35.25,1,'1',NULL),('3','test per post method','ina@test.com','user','2021-03-06 21:07:38','2021-03-06 21:07:39',0.00,2,'1','inaina');
...
-- Dump completed on 2021-05-29 14:20:56
