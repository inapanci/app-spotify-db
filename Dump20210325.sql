...
INSERT INTO `payment_methods` VALUES (1,'paypal',NULL,NULL,NULL,NULL,NULL),(2,'coinbase',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `products` (
  ...
  KEY `fk2_filter_id_idx` (`filter`),
  CONSTRAINT `fk1_status_id` FOREIGN KEY (`status_id`) REFERENCES `product_status` (`id`),
  CONSTRAINT `fk_filter_id` FOREIGN KEY (`filter`) REFERENCES `filters` (`id`)
...
INSERT INTO `users` VALUES ('1','ina','UPDATEDina@test.com','user',NULL,NULL,15.25,NULL,'1','inaina'),('2','test','test@test.com','admin',NULL,NULL,35.25,NULL,'1',NULL),('njhgvuwe','test per post method','ina@test.com','user','2021-03-06 21:07:38','2021-03-06 21:07:39',0.00,NULL,'1','inaina');
...
INSERT INTO `users_payment_methods` VALUES ('1',1),('2',1),('1',2);
...
-- Dump completed on 2021-03-25 23:53:40
